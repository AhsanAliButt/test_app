...
export default function Reports() {
  return (
    <section className="py-[30px] sm:py-[70px] px-[20px] sm:px-[30px] bg-reports-bg">
      <div className="p-[40px] xl:pl-[280px] bg-white sm:py-[60px] max-w-[1512px] rounded-[25px] mx-auto">
        <div className="max-w-[1209px] flex flex-col lg:flex-row gap-[60px] sm:gap-[266px] mx-auto items-center">
          ...
          <h2 className="text-[20px] text-center sm:text-center sm:text-[33px] lg:text-[28px] xl:text-[33px] font-medium">
