  ...
  return (
    <section className="py-[30px] sm:py-[70px] px-[20px] sm:px-[30px] bg-automate-bg">
      <div className="p-[40px] bg-white  sm:py-[60px] max-w-[1512px] rounded-[25px] mx-auto">
        <div className="max-w-[1209px] flex flex-col-reverse lg:flex-row gap-[30px] sm:gap-[65px] mx-auto items-center">
          <h2 className="text-[20px] text-center sm:text-left sm:text-[33px] font-medium mt-8 xl:mt-0">
