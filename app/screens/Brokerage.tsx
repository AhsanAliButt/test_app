  ...
  return (
    <section className="py-[30px] sm:py-[70px] px-5 sm:px-[30px] bg-brokerage-bg">
      <div className="px-[40px] bg-white py-[40px] sm:py-[60px] max-w-[1512px] rounded-[25px] mx-auto">
        <div className="max-w-[1209px] xl:w-auto flex lg:flex-row flex-col-reverse gap-[30px] sm:gap-[65px] mx-auto items-center">
          <h2 className="text-[20px] lg:w-[50%] text-center sm:text-left sm:text-[33px] font-medium">
          ...
          <div className="min-w-[250px] h-[200px] w-auto lg:w-[50%] xl:min-w-[642px] group relative md:h-[280px] xl:h-[480px]">
            <Image
